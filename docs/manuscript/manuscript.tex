...
A primary aim of our survey was to establish the current level of knowledge and experience geographic researchers have with reproducibility enhancing research practices.
...
In aggregate, respondents identified reproducibility as an important means of achieving numerous epistemic goals in geographic research (Q17).
\begin{itemize}
    \item reducing the risk of persistent errors (77.5\%)
    \item preventing duplication of research efforts (63.3\%)
    \item communicating results to academics (68.8\%)
    \item communicating results to practitioners (64.7\%)
    \item Researchers also view attempting reproductions as an important part of student training (75.7\%). 
\end{itemize}

Qualitative researchers identified reproducibility as playing a much smaller role in the research process when compared to quantitiative or mixed-methods researchers. 
