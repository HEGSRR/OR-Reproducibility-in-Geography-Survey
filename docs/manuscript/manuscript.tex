...
ACCESS MATERIALS - Q12.
The majority of researchers (82/102) that attempted reproductions were able to access at least some of the data used in the original study, but only (27/102) could access all of the original data.


OUTCOME - Q11 AND OUTCOME BY ACCESS Q12
Geographic researchers report being able to recreate some the results they attempt to reproduce, but few researchers report being able to identically recreate all results (20/102). 
