...
\begin{table}[h]
    ...
    \begin{tabular}{l c c c c c c c c c c}
         ...
         \hline
         Definition (\textit{d}) & \begin{tabular}[c]{@{}c@{}}1.76\\ (1.17)\end{tabular} & 
                        \begin{tabular}[c]{@{}c@{}}1.68\\ (1.12)\end{tabular} & 
                        \begin{tabular}[c]{@{}c@{}}1.97\\ (1.08)\end{tabular} &
                        \begin{tabular}[c]{@{}c@{}}1.77\\ (1.10)\end{tabular} & 
                        & 
                        \begin{tabular}[c]{@{}c@{}}1.89\\ (1.14)\end{tabular} & 
                        \begin{tabular}[c]{@{}c@{}}1.53\\ (1.28)\end{tabular} & 
                        \begin{tabular}[c]{@{}c@{}}1.78\\ (1.06)\end{tabular} & 
                        & 
                        \begin{tabular}[c]{@{}c@{}}1.77\\ (1.15)\end{tabular} \\
