...
First, we used descriptive statistical summaries of the participant response to address how geographic researchers define reproducibility, their familiarity and experience with reproducible research practice, and the barriers to reproducibility they perceive in the discipline.
...
Of our 218 respondents, \textit{$n_{1}$}=217 (99.5\%) provided information sufficient for our first analysis of geographic researchers' understanding and perception of reproducibility.
