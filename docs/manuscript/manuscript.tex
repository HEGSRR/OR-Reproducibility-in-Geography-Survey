...
ADD COMPARISON TO SAMPLE FRAME.

\subsection*{PCAish Summary Across Dimensions}
This subsection will pivot on Table 9 that has rows representing PCA-like aggregate measures of 1) definition, 2) Familiarity 3)practice, 4) Barriers and two groups of rows (Quant, Qual, Mixed) and (Human, Physical, GIS/Methods, NS).

\subsubsection*{Definition of Reproducibility}
Definition Questions and Q8 about beliefs about the interpretation for reproductions. Dig into those respondents that had variations in beliefs on Q8 sequence. Q17 about importance of reproduction. Close with Q13.
