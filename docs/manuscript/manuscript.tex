...
\begin{itemize}
    \item Include a comparison of sample to the sample frame along the dimensions available from the frame. (Table 0)
    \item Include a summary of the key in sample characteristics (Table 1?). Rows - Title, Citations (pulled from frame), Gender; cols - methods and subfields. \textcolor{red}{Does this need to be a table? I am not sure any of these demographics really matter to our analysis. That is unless we plan to look at some measure across seniority or 'impact', which we could do.}
\end{itemize}
...
\begin{itemize}
    \item Self-reported definition (Q6) analysis.
    \item Interpretations of reproductions (Q8) - focus on Q8a, Q8b, Q8e as these provide the most direct information about how a respondent processes the evidence provided by a reproduction. Match Q8e with 17c, 17e, 17f which are importance questions about credibility. Match Q8b with 17a which are both about validity. 
    \item Importance of reproducibility (Q17) - Reproducibility was/wasn't seen as important for other goals - error reduction (17b), effort duplication (17d), scientific communication (17g, 17h), training (17i, 8d).
    \item Reproducibility Estimate (Q13) - \textcolor{red}{What is the state of the summaries on this dimension?}
\end{itemize}

\subsubsection*{Familiarity with Reproduciblity Practices}


\subsubsection*{Frequency of Reproduciblity Practices}

Q9 will feather in to contextualize the measure

\subsubsection*{Barriers to Reproduction}
Discussion of details from Q14
