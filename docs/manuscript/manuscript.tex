...
\begin{itemize}
    \item Attempting reproductions
    \item Attempting reproductions in geography
\end{itemize}
...
\begin{itemize}
    \item Reproducibility surveys
    \item the problems with these surveys
    \item reproducibilty surveys in geography
    \item how they fall prey to the same problems
\end{itemize}
