...
However, researchers estimated that only half of the results published in the discipline were reproducible ($\overline{rep}=50.6\%$, $\sigma=24.7\%$) and reported limited familiarity with and use of many reproducible research practices. 
...
Geographic researchers provided definitions of reproducibility that generally explicitly included one to two of the four characteristics ($\overline{d}=1.77$) from the definition adopted by the NASEM.
